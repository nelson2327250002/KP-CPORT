...
const AppHeader: React.FC = () => {
  ...
  return (
    // MODIFIKASI: Menghapus pembatas lebar dan memastikan bg penuh
    <header className="sticky top-0 flex w-full border-b border-gray-200 z-9999 bg-white dark:border-gray-800 dark:bg-gray-900">
      {/* MODIFIKASI: Menghapus lg:px-6 agar konten mepet ke ujung layar */}
      <div className="flex flex-col items-center justify-between grow lg:flex-row w-full px-4">
        
        {/* SISI KIRI: Tombol Toggle & Search */}
        <div className="flex items-center justify-between w-full gap-2 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <button onClick={toggleApplicationMenu} className="flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* SISI KANAN: User Profile & Notification */}
        <div className={`${isApplicationMenuOpen ? "flex" : "hidden"} items-center justify-between w-full gap-4 px-5 py-4 lg:flex lg:justify-end lg:px-0 lg:shadow-none`}>
